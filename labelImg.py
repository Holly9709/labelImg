...
class MainWindow(QMainWindow, WindowMixin):
   ...
   #     self.labelMethod = 'detect'
        ...
        help = action('&Tutorial', self.tutorial, 'Ctrl+T', 'help',
                u'Show demos')
        verify = action('&Verify image', self.verify, 
                u'verify')
   ...
   #     libs.canvas.labelMethod(self.labelMethod)
    ...
    def loadFile(self, filename=None):
        ...
        if QFile.exists(filename):
            if LabelFile.isLabelFile(filename):
                ...
                #print "load image filename: ",filename
    ...
    def openNextImg(self,dirpath = None, _value=False):
        ...
        isExists = os.path.exists('C:\markimage')
        if not isExists:
            os.makedirs('C:\markimage')
            print "C:\markimage is created successfully."

        isExists = os.path.exists('C:\markxml')
        if not isExists:
            os.makedirs('C:\markxml')
            print "C:\markxml is created successfully."
